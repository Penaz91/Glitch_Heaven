...
class Particle (pygame.sprite.Sprite):
    def __init__(self, position, *groups):
        ...
        self.colorsteps = self.colorfade(self.color, (0, 0, 0), 100)
    ...
    def colorfade(self, startcolor, finalcolor, steps):
        stepR = max(1, (finalcolor[0]-startcolor[0])/steps)
        stepG = max(1, (finalcolor[1]-startcolor[1])/steps)
        stepB = max(1, (finalcolor[2]-startcolor[2])/steps)
