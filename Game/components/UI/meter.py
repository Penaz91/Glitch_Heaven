...
class Meter(object):
    ...
    """
    # TODO: Add a way to make the slider really work when you keep the mouse button pressed
    def __init__(self, location, size=(0,0)):
        ...
        self.size = size
        self.image = pygame.surface.Surface(((size[0]), (size[1])),pygame.SRCALPHA,32).convert_alpha()
        self.image.fill((255, 255, 255))
        self.rect = self.image.get_rect()
        self.rect.x, self.rect.y = self.location
        self.filler = pygame.surface.Surface((0,size[1]),pygame.SRCALPHA,32).convert_alpha()
    ...
    def set_quantity(self, mousepos):
        ...
        self.filler = pygame.surface.Surface((x,self.size[1]),pygame.SRCALPHA,32).convert_alpha()
        self.fillerrect = self.filler.get_rect()
        self.filler.fill((255, 0, 0))
    ...
    def draw_from_x (self, x):
        ...
        """
        self.filler = pygame.surface.Surface(((x/100.)*self.rect.size,self.size[1]),pygame.SRCALPHA,32).convert_alpha()
        self.fillerrect = self.filler.get_rect()
        self.filler.fill((255, 0, 0))
